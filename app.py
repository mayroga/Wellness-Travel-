...
story.append(Paragraph("Wellness Travel Architecture & Lifestyle Optimization | Miami, Florida | USA", subtitle_style))
...
def read_index():
    return "MAY ROGA LLC - Production Backend Operational"
